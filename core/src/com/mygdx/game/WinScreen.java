...
public class WinScreen implements Screen {
    ...
    public WinScreen(Game game) {
        ...
        Label.LabelStyle labelStyle = new Label.LabelStyle(font, Color.GREEN); // Create a new LabelStyle with the font

        Label gameOverLabel = new Label("You Win", labelStyle); // Use the style to create the Label
